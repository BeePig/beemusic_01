...
import static com.framgia.beemusic.data.source.local.song.SongSourceContract.SongEntry.COLUMN_ID_SERVER;
...
public class DataHelper extends SQLiteOpenHelper {
    ...
    private static final String COMMA_CREATE_SONG_TABLE =
        COMMA_CREATE_TABLE + TABLE_SONG_NAME + " ("
            ...
            + COLUMN_ID_SERVER + INTERGER_TYPE + NOT_NULL + COMMA_SEP
