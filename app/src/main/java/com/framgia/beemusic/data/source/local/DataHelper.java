...
import static com.framgia.beemusic.data.source.local.album.AlbumSourceContract.AlbumEntry
        .COLUMN_ID_ALBUM;
import static com.framgia.beemusic.data.source.local.album.AlbumSourceContract.AlbumEntry
        .COLUMN_IMAGE_LINK;
import static com.framgia.beemusic.data.source.local.album.AlbumSourceContract.AlbumEntry
        .TABLE_ALBUM_NAME;
import static com.framgia.beemusic.data.source.local.singer.SingerSourceContract.SingerEntry
        .COLUMN_ID_SINGER;
import static com.framgia.beemusic.data.source.local.singer.SingerSourceContract.SingerEntry
        .TABLE_SINGER_NAME;
import static com.framgia.beemusic.data.source.local.song.SongSourceContract.SongEntry
        .COLUMN_DURATION;
...
import static com.framgia.beemusic.data.source.local.song.SongSourceContract.SongEntry
        .TABLE_SONG_NAME;
import static com.framgia.beemusic.data.source.local.songalbum.SongAlbumSourceContract
        .SongAlbumEntry.TABLE_SONG_ALBUM_RELATIONSHIP_NAME;
import static com.framgia.beemusic.data.source.local.songsinger.SongSingerSourceContract
        .SongSingerEntry.TABLE_SONG_SINGER_RELATIONSHIP_NAME;
...
public class DataHelper extends SQLiteOpenHelper {
    ...
    private static final String COMMA_CREATE_SONG_TABLE = COMMA_CREATE_TABLE
            + TABLE_SONG_NAME
            + " ("
            + COLUMN_ID_SONG
            + INTERGER_TYPE
            ...
            + INTERGER_TYPE
            + " )";
    private static final String COMMA_CREATE_ALBUM_TABLE = COMMA_CREATE_TABLE
            + TABLE_ALBUM_NAME
            + " ("
            + COLUMN_ID_ALBUM
            + INTERGER_TYPE
            ...
            + TEXT_TYPE
            + " )";
    private static final String COMMA_CREATE_SINGER_TABLE = COMMA_CREATE_TABLE
            + TABLE_SINGER_NAME
            + " ("
            + COLUMN_ID_SINGER
            + INTERGER_TYPE
            ...
            + TEXT_TYPE
            + " )";
    private static final String COMMA_CREATE_TEMP_SONG_ALBUM_TABLE = COMMA_CREATE_TABLE
            + TABLE_SONG_ALBUM_RELATIONSHIP_NAME
            + " ("
            + COLUMN_ID_SONG
            + INTERGER_TYPE
            + COMMA_SEP
            ...
            + COLUMN_ID_ALBUM
            + "))";
    private static final String COMMA_CREATE_TEMP_SINGER_SONG_TABLE = COMMA_CREATE_TABLE
            + TABLE_SONG_SINGER_RELATIONSHIP_NAME
            + " ("
            + COLUMN_ID_SINGER
            + INTERGER_TYPE
            + COMMA_SEP
            ...
            + COLUMN_ID_SINGER
            + "))";
    private static final String COMMA_DROP_SONG_TABLE = DROPTABLE_IF_EXIST + TABLE_SONG_NAME;
    private static final String COMMA_DROP_ALBUM_TABLE = DROPTABLE_IF_EXIST + TABLE_ALBUM_NAME;
    private static final String COMMA_DROP_SINGER_TABLE = DROPTABLE_IF_EXIST + TABLE_SINGER_NAME;
